        ...
        VStack(alignment: .leading, spacing: 6) {
            ...
            ForEach(displayManager.displays.filter { !$0.isMain }) { display in
                Button(action: {
                    ...
                    Label("Make \(display.name) the main display", systemImage: "star.fill")
                        .font(.caption)
                ...
                .buttonStyle(.plain)
                .help("Make this the main display")
            }
        }
        ...
        Task { @MainActor in
            ...
            if ok {
                ...
                withAnimation(.easeInOut(duration: 0.2)) {
                    dragError = "Could not arrange the displays. Try again."
                }
...
private struct DisplayThumbnailView: View {
    ...
    var body: some View {
        ZStack {
            ...
            // Decorative bar along the top of an external display, suggesting a bezel
            ...
            // Display name plus the main-display marker
            VStack(spacing: 2) {
                Text(display.name)
