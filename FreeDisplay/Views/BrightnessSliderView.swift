...
struct BrightnessSliderView: View {
    ...
    var body: some View {
        VStack(spacing: 2) {
            ...
            .padding(.top, 2)
            .accessibilityLabel(display.isBuiltin ? "Brightness control: system" : "Brightness control: \(ddcStatus == true ? "DDC hardware" : "Software")")
            .help(display.isBuiltin ? "System brightness: the built-in display is controlled through the system API" : "DDC: the hardware controls brightness directly\nSoftware: brightness is simulated in software")
