...
struct ImageAdjustmentView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            adjustRow(icon: "thermometer.medium",        label: "Colour temperature",    value: $colorTemperature).help("Adjust colour temperature")
            quantizationRow
            ...
            HStack(spacing: 5) {
                Image(systemName: "exclamationmark.triangle.fill")
                    ...
                    .font(.caption)
                Text("Adjustments can affect HDR content.")
                    .font(.caption)
            ...
            HStack(spacing: 8) {
                ...
                .help("Invert the display's colours (similar to night mode)")

                actionButton(
                    title: isPaused ? "Resume Adjustment" : "Pause Adjustment",
                ...
                .help("Temporarily disable colour adjustment and restore the original picture")
                ...
                .help("Reset every colour adjustment to its default")
            }
            .padding(.horizontal, 12)
            .padding(.bottom, 8)
        }
    ...
    private var quantizationRow: some View {
        HStack(spacing: 8) {
            ...
            .help("Adjust the quantisation level")
