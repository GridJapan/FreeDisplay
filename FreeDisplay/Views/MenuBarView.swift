...
struct SettingsView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 6) {
            ...
            .controlSize(.small)
            .padding(.horizontal, 12)
            .help("Launch FreeDisplay at login")
            ...
            .controlSize(.small)
            .padding(.horizontal, 12)
            .help("Show one brightness slider for all displays in the menu bar")
            ...
            .controlSize(.small)
            .padding(.horizontal, 12)
            .help("Check for a new version automatically at every launch")
        }
        .padding(.vertical, 6)
    }
}
...
struct DisplayRowView: View {
    ...
    var body: some View {
        HStack(spacing: 0) {
            ...
            .help("Expand the display controls")
        }
        .padding(.horizontal, 12)
        .padding(.vertical, 6)
        .background(Color.primary.opacity(isHovered ? 0.06 : 0))
